        ...
        <div className="mt-4 pt-3 border-t border-white/10">
          <div className="text-white/40 text-xs flex items-center justify-center gap-1">
            <svg
              ...
              className="w-3 h-3 fill-current" // 'fill-current' hace que use el color del texto
            >
            ...
            <span>Municipio de San Juan del Río. Todos los derechos reservados. {new Date().getFullYear()}</span>
          </div>
        </div>
      </div>
    </footer>
