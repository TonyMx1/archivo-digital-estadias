        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
            ...
            <div className="pt-4">
              <div className="bg-blue-50 border-l-4 border-[#0076aa] p-4 rounded">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-md font-medium text-[#0076aa]">
                      ¡Bienvenido!
                    </p>
                  </div>
                </div>
          ...
          <div className="pt-4 border-t border-gray-200">
            <button
              ...
              className="w-full bg-[#0076aa] text-white font-semibold py-3 px-4 rounded-lg hover:bg-[#005a85] focus:outline-none focus:ring-2 focus:ring-[#00b2e2] focus:ring-offset-2 transition-all shadow-lg"
            >
              Cerrar sesión
            </button>
          </div>
